...
public class DriverStick {
    ...
    private DrivePair interp(DrivePair ll, DrivePair lr, DrivePair ul,
            DrivePair ur, double x, double y)
    {
        interpLeft.leftPower =
                ll.leftPower + (ul.leftPower - ll.leftPower)*y;
        interpLeft.rightPower =
                ll.rightPower + (ul.rightPower - ll.rightPower)*y;
        interpRight.leftPower = 
                lr.leftPower + (ur.leftPower - lr.leftPower)*y;
        interpRight.rightPower =
                lr.rightPower + (ur.rightPower - lr.rightPower)*y;
        return new DrivePair(
            interpLeft.leftPower + (interpRight.leftPower - interpLeft.leftPower) * x,
