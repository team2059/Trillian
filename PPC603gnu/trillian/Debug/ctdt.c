...
void _GLOBAL__I__ZN12Extreme3dProC2Eh();

void _GLOBAL__I__ZN13AirCompressorC2Ehh();

void _GLOBAL__I__ZN6HHBaseC2Ev();

void _GLOBAL__I__ZN7HHRobotC2Ev();

void _GLOBAL__I__ZN7WCDriveC2Ehhhhii();

void _GLOBAL__I__ZN9SmartDashC2Ev();
...
void _GLOBAL__I__ZN8Resource12m_createLockE();

void _GLOBAL__I__ZN9RobotBase10m_instanceE();

void _GLOBAL__I__ZN14SmartDashboard7m_tableE();

void _GLOBAL__I__ZN12SolenoidBase11m_semaphoreE();
...
void _GLOBAL__I__ZN12BooleanArray20BOOLEAN_ARRAY_RAW_IDE();

void _GLOBAL__I__ZN17DefaultEntryTypes7BOOLEANE();

void _GLOBAL__I__ZN11NumberArray19NUMBER_ARRAY_RAW_IDE();

void _GLOBAL__I__ZN11StringArray19STRING_ARRAY_RAW_IDE();

extern void (*_ctors[])();
void (*_ctors[])() =
    {
    _GLOBAL__I__ZN12Extreme3dProC2Eh,
    _GLOBAL__I__ZN13AirCompressorC2Ehh,
    _GLOBAL__I__ZN6HHBaseC2Ev,
    _GLOBAL__I__ZN7HHRobotC2Ev,
    _GLOBAL__I__ZN7WCDriveC2Ehhhhii,
    _GLOBAL__I__ZN9SmartDashC2Ev,
    ...
    _GLOBAL__I__ZN14SmartDashboard7m_tableE,
    _GLOBAL__I__ZN12SolenoidBase11m_semaphoreE,
    ...
    _GLOBAL__I__ZN17DefaultEntryTypes7BOOLEANE,
    _GLOBAL__I__ZN11NumberArray19NUMBER_ARRAY_RAW_IDE,
    _GLOBAL__I__ZN11StringArray19STRING_ARRAY_RAW_IDE,
    0
    };

void _GLOBAL__D__ZN12Extreme3dProC2Eh();

void _GLOBAL__D__ZN13AirCompressorC2Ehh();

void _GLOBAL__D__ZN6HHBaseC2Ev();

void _GLOBAL__D__ZN7HHRobotC2Ev();

void _GLOBAL__D__ZN7WCDriveC2Ehhhhii();

void _GLOBAL__D__ZN9SmartDashC2Ev();

void _GLOBAL__D__ZN9Scheduler9_instanceE();

void _GLOBAL__D_wpi_error_s_ModuleIndexOutOfRange();

void _GLOBAL__D__ZN17MotorSafetyHelper12m_headHelperE();

void _GLOBAL__D__ZN8Notifier21kTimerInterruptNumberE();

void _GLOBAL__D__ZN8Resource12m_createLockE();

void _GLOBAL__D__ZN9RobotBase10m_instanceE();

void _GLOBAL__D__ZN14SmartDashboard7m_tableE();

void _GLOBAL__D__ZN12SolenoidBase11m_semaphoreE();
...
void _GLOBAL__D__ZN12BooleanArray20BOOLEAN_ARRAY_RAW_IDE();

void _GLOBAL__D__ZN17DefaultEntryTypes7BOOLEANE();

void _GLOBAL__D__ZN11NumberArray19NUMBER_ARRAY_RAW_IDE();

void _GLOBAL__D__ZN11StringArray19STRING_ARRAY_RAW_IDE();

extern void (*_dtors[])();
void (*_dtors[])() =
    {
    _GLOBAL__D__ZN12Extreme3dProC2Eh,
    _GLOBAL__D__ZN13AirCompressorC2Ehh,
    _GLOBAL__D__ZN6HHBaseC2Ev,
    _GLOBAL__D__ZN7HHRobotC2Ev,
    _GLOBAL__D__ZN7WCDriveC2Ehhhhii,
    _GLOBAL__D__ZN9SmartDashC2Ev,
    _GLOBAL__D__ZN9Scheduler9_instanceE,
    _GLOBAL__D_wpi_error_s_ModuleIndexOutOfRange,
    _GLOBAL__D__ZN17MotorSafetyHelper12m_headHelperE,
    _GLOBAL__D__ZN8Notifier21kTimerInterruptNumberE,
    _GLOBAL__D__ZN8Resource12m_createLockE,
    _GLOBAL__D__ZN9RobotBase10m_instanceE,
    _GLOBAL__D__ZN14SmartDashboard7m_tableE,
    _GLOBAL__D__ZN12SolenoidBase11m_semaphoreE,
    ...
    _GLOBAL__D__ZN17DefaultEntryTypes7BOOLEANE,
    _GLOBAL__D__ZN11NumberArray19NUMBER_ARRAY_RAW_IDE,
    _GLOBAL__D__ZN11StringArray19STRING_ARRAY_RAW_IDE,
    0
    };
